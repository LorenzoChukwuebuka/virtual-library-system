  ...
  <div>
    ...
    <div id="modal2" class="modal">
      ...
      <div class="modal-footer">
        <a
          href="#!"
          class="modal-close blue darken-2 waves-effect waves-green btn-flat"
          >Done</a
        >
      </div>
    </div>
    ...
    <div id="modal1" class="modal">
      <div class="modal-content">
          ...
          <form class="col s12">
            ...
            <div class="row">
              <div class="input-field ">
                <button
                  class=" waves-effect blue waves-green btn-flat"
                  @click="update"
                >
        ...
        <div class="modal-footer">
          <button class="modal-close waves-effect blue waves-green btn-flat">
...
export default {
  ...
  methods: {
    submit(e) {
      e.preventDefault();
      axios
        .post("http://localhost:5000/api/admin/AddDept", this.form)
        .then((res) => {
          if (res.data === 201) {
    ...
    deleteDept(Id) {
      axios.delete(`http://localhost:5000/api/admin/dept/${Id}`).then((res) => {
        if (res.data === 200) {
    ...
    update(e) {
      ...
      let Id = this.edit.Id;
      axios
        .put(`http://localhost:5000/api/admin/dept/${Id}`, this.edit)
        .then((res) => {
          if (res.data === 200) {
