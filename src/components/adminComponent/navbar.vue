    ...
    <ul id="slide-out" class="sidenav grey">
      <li>
        <div class="user-view">
          ...
          <a
            ><span class="white-text name">{{ username }}</span></a
          >
        </div>
      </li>
      <li><div class="divider"></div></li>
      <li>
        <a @click="addschool"><i class="material-icons">add</i> Add School </a>
      </li>
      <li>
        <a @click="adddept"
      ...
      <li>
        <a @click="addCat"><i class="material-icons">add</i> Add category </a>
      </li>
      <li>
        <a @click="upload"><i class="material-icons">add</i> upload files </a>
      </li>

      <li>
        <a><i class="material-icons">visibility</i> view all </a>
      </li>
    </ul>
